...
window.addEventListener('load', function() {
    console.log("called");
    window.web3 = new Web3(new Web3.providers.HttpProvider("http://"+location.host+"/jsonrpcA"));
  ...
  var userPassword =  document.getElementById('password').value;
    ...
    return instance.getUser(userName , userPassword, {from:web3.eth.accounts[0]})}).then(function(val) {
        ...
        if(val != "0x") {
    	 ...
    	 var expires = "expires=" + d.toGMTString();
    	 document.cookie = "address" + "=" + val[0]+ ";" + expires + ";path=/";
         document.cookie = "password" + "=" + userPassword+ ";" + expires + ";path=/";
         document.cookie = "username" + "=" + userName+ ";" + expires + ";path=/";
         document.cookie = "userrole" + "=" + val[1]+ ";" + expires + ";path=/";
